...
<div align="center">
  <table width="100%" border="0" cellspacing="0" cellpadding="10" style="background-color: #0d1117; border: 1.5px solid #30363d; border-radius: 10px;">
    <tr>
      <!-- LEFT COLUMN: PHOTO ASCII ART IN MONOSPACED TERMINAL -->
      <td width="48%" valign="top" style="border-right: 1px stroke #21262d;">
        <p align="left" style="font-family: monospace; font-size: 11px; color: #00ff7f; margin: 0 0 8px 0; font-weight: bold;">
          ❯ ./render_ascii_portrait.sh --photo photo.jpg
        </p>
        <pre style="font-family: 'JetBrains Mono', 'Courier New', monospace; font-size: 8px; line-height: 9px; color: #00e5ff; background-color: #050811; padding: 10px; border-radius: 6px; border: 1px solid #1e293b; margin: 0; overflow-x: auto;"><b>                 .:::-------:::.              
             .::-#%@@@@@@@@@@@%#-::.          
           .:#@@@@@@@@@@@@@@@@@@@@@#:.        
          -%@@@@@@@@@@@@@@@@@@@@@@@@@%-       
         +@@@@@@@@@@@@@@@@@@@@@@@@@@@@@+      
   ...
   | | | | | |    \____________/   | | | | | |
    \  | | | |                     | | | |  /
     \ | | | |                     | | | | / 
      \| | | |                     | | | |/  
       ':| | |                     | | |:'   </b></pre>
        <p align="left" style="font-family: monospace; font-size: 11px; color: #00e5ff; margin: 8px 0 0 0; font-weight: bold;">
          ❯ <span style="color: #e2e8f0;">Photo ASCII Render Complete.</span> <span style="color: #00e5ff;">█</span>
        </p>
      </td>
  ...
  <table width="100%" style="background-color: #0d1117; border: 1.5px solid #30363d; border-radius: 10px; padding: 12px;">
    <tr>
      <td align="center">
        ...
        <p style="font-family: monospace; font-size: 11px; color: #8b949e; margin-top: 0;">
